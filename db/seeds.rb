...
Kitchen.create(title: "no kitchen better", street_address: "71 Clark Street", city: "New York", state: "NY", zipcode: 11201, size: 800, max_guests: 4, base_price: 100, price_per_guest: 20, owner_id: 7,
...
Kitchen.create(title: "a kitchen so good you'll cook yourself", street_address: "72 Clark Street", city: "New York", state: "NY", zipcode: 11201, size: 450, max_guests: 8, base_price: 50, price_per_guest: 10, owner_id: 6,
...
Kitchen.create(title: "youve never seen such luxury", street_address: "73 Clark Street", city: "New York", state: "NY", zipcode: 11201, size: 450, max_guests: 12, base_price: 30, price_per_guest: 6, owner_id: 5,
...
Kitchen.create(title: "you will never be happy but you can rent this kitchen", street_address: "74 Clark Street", city: "New York", state: "NY", zipcode: 11201, size: 450, max_guests: 14, base_price: 60, price_per_guest: 8, owner_id: 4,
...
Kitchen.create(title: "life is nothing but a rental / rent my kitchen", street_address: "75 Clark Street", city: "New York", state: "NY", zipcode: 11201, size: 450, max_guests: 6, base_price: 20, price_per_guest: 5, owner_id: 3,
  knives: "wusthof", pots: "le creuset", pans: "copper", food_processor: true, standing_mixer: false, deep_fryer: true, pressure_cooker: true,
  blurb: "not a sex dungeon", description: "We denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects pleasures to secure other greater pleasures, or else he endures pains to avoid worse pains.")
Kitchen.create(title: "nietzsche would have loved this kitchen", street_address: "76 Clark Street", city: "New York", state: "NY", zipcode: 11201, size: 450, max_guests: 8, base_price: 75, price_per_guest: 15, owner_id: 2,
  knives: "wusthof", pots: "le creuset", pans: "copper", food_processor: true, standing_mixer: false, deep_fryer: true, pressure_cooker: true,
