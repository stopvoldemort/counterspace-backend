...
Kitchen.create(title: "youve never seen such luxury", street_address: "709 Honey Creek Dr.", city: "New York", state: "NY", zipcode: 10028, size: 450, max_guests: 12, base_price: 30, price_per_guest: 6, owner_id: 7,
  ...
  blurb: "don't think about any other kitchen", latitude: 40.762935, longitude: -73.962879, description: "We denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty or the obligations of business it will frequently occur that pleasures have to be repudiated and annoyances accepted. The wise man therefore always holds in these matters to this principle of selection: he rejects pleasures to secure other greater pleasures, or else he endures pains to avoid worse pains.")
...
Message.create(content: "first message", recipient_id: 7, sender_id: 1, reservation_id: 7, read: false)
Message.create(content: "second message", recipient_id: 7, sender_id: 1, reservation_id: 7, read: false)
Message.create(content: "third message", recipient_id: 1, sender_id: 7, reservation_id: 7, read: false)
Message.create(content: "fourth message", recipient_id: 1, sender_id: 7, reservation_id: 7, read: false)
Message.create(content: "fifth message", recipient_id: 7, sender_id: 1, reservation_id: 7, read: false)
